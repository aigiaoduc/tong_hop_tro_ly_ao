...
const FREE_APPS: AppMetadata[] = [
  {
    ...
    link: 'https://trolyaothayquan.vercel.app/',
    downloads: 4500
  },
  {
    id: 'free_2',
    ...
    category: 'AI Coding',
    type: AppType.FREE,
    status: AppStatus.MAINTENANCE, // TRẠNG THÁI: ĐANG BẢO TRÌ
    icon: 'Zap',
    previewUrl: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=800&q=80',
    link: 'apps/coding-helper.html',
    downloads: 6780
  }
];
...
const PAID_APPS: AppMetadata[] = [
  ...
  },
  {
    ...
    category: 'Education',
    type: AppType.PAID,
    status: AppStatus.INACTIVE, // TRẠNG THÁI: NGƯNG HOẠT ĐỘNG
    price: 9.99,
    icon: 'Brain',
    previewUrl: 'https://images.unsplash.com/photo-1543269865-cbf427effbad?w=800&q=80',
    link: 'apps/english-tutor.html',
    downloads: 2310
  }
];
