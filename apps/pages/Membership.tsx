        ...
        <div className="fixed inset-0 z-[160] flex items-center justify-center px-4">
          ...
          <div className="relative bg-[#0f172a] w-full max-w-md rounded-[2.5rem] p-8 md:p-10 border border-indigo-500/20 shadow-2xl animate-in zoom-in duration-300">
            ...
            <div className="text-center space-y-6">
              ...
              <h3 className="text-2xl font-black text-white uppercase tracking-tight">Kích hoạt tài khoản</h3>
              <div className="space-y-4 text-left">
                <div className="flex gap-4 p-4 bg-white/5 rounded-2xl border border-white/5">
                  ...
                  <p className="text-gray-300 text-xs font-bold leading-relaxed">Mở ứng dụng <span className="text-indigo-400">Zalo</span> trên thiết bị của bạn.</p>
                </div>
                <div className="flex gap-4 p-4 bg-white/5 rounded-2xl border border-white/5">
                  <div className="w-6 h-6 rounded-full bg-indigo-600 flex items-center justify-center text-[10px] font-black shrink-0">2</div>
                  <p className="text-gray-300 text-xs font-bold leading-relaxed">Tìm kiếm số điện thoại: <span className="text-indigo-400 font-black">0355 213 107</span></p>
                </div>
                <div className="flex gap-4 p-4 bg-white/5 rounded-2xl border border-white/5">
                  <div className="w-6 h-6 rounded-full bg-indigo-600 flex items-center justify-center text-[10px] font-black shrink-0">3</div>
                  <p className="text-gray-300 text-xs font-bold leading-relaxed">Gửi ảnh màn hình chuyển khoản cho Zalo tên <span className="text-indigo-400 font-black">Trần Hồng Quân</span> để được cấp mã VIP.</p>
                </div>
              </div>
              <button onClick={() => setShowZaloInstructions(false)} className="w-full bg-indigo-600 text-white py-4 rounded-xl font-black uppercase text-xs tracking-widest active:scale-95 transition-all">Đã rõ</button>
            </div>
          </div>
        </div>
      )}
